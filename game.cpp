...
public:
	...
	void loadEO( const char * filename )
	{
		...
		for( ulong objNum = 0; objNum < numObjects; objNum++ )
		{
			...
			Surface * surface = new Surface[ numMaterials ] ;
...
{	
	...
	//scene->loadO3D( "data\\level1\\level1.o3d" );
	...
	*/
	...
	camera->attachTo( pivot, 0 ); camera->setPosition( btVector3( 0, 5, 0 ));
